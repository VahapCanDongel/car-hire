    ...
    return(
        <div className="p-20 flex flex-col justify-center items-center gap-6">
            <div className="flex justify-center items-center w-full flex-col">
                ...
                <div className="text-[35px] font-bold">Frequently Asked Questions</div>

                <p className="w-[600px] text-center text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto rem sunt voluptatem maiores adipisci vel possimus quod eveniet quisquam non?</p>
            </div>
